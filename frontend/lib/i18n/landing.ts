...
export const LANDING_I18N: Record<LandingLang, LandingMessages> = {
  en: {
    ...
    demoSubtitle: "Real-time AI voice guide · 7 languages · No app needed",
  ...
  vi: {
    ...
    demoSubtitle: "Hướng dẫn giọng nói AI · 7 ngôn ngữ · Không cần cài app",
  ...
  fr: {
    ...
    demoSubtitle: "Guide vocal IA en temps réel · 7 langues · Sans installation",
  ...
  ja: {
    ...
    demoSubtitle: "リアルタイムAI音声ガイド · 7言語対応 · アプリ不要",
  ...
  ko: {
    ...
    demoBadge: "+ AI 뮤지엄 경험",
    demoSubtitle: "실시간 AI 음성 가이드 · 7개 언어 · 앱 설치 불필요",
  ...
  zh: {
    ...
    demoBadge: "+ AI 博物馆体验",
    demoSubtitle: "实时AI语音导览 · 7种语言 · 无需安装应用",
  ...
  es: {
    ...
    demoSubtitle: "Guía de voz IA en tiempo real · 7 idiomas · Sin instalación",
