...
async def seed_firestore(project_id: str | None = None):
    ...
    museum_data = {
        ...
        "supported_languages": ["vi", "en", "de", "ru", "ar", "es", "fr", "ja", "ko", "zh"],
        "default_language": "vi",
        ...
        "welcome_message": {
            ...
            "de": "Willkommen! Ich bin Ihr KI-Museumsführer.",
            "ru": "Добро пожаловать! Я ваш ИИ-гид по музею.",
            "ar": "مرحبًا! أنا مرشدك الذكي في المتحف.",
