...
1. Frontend shows CORS / cannot call backend
...
1. Voice connects then closes immediately
...
1. Camera recognition always unknown
...
1. Admin login fails on fresh setup
